...
//  TH1F *HBHE_Energy_D1		      = makeTH1F("HBHE_Energy_D1" ,"HBHE: E>5GeV Depth 1", 50, 0, 0);
  TH1F *HBHE_TSRatio_D1		      = makeTH1F("HBHE_TSRatio_D1","HBHE: TS3>30fC  Depth 1", 30, 0,0);
  TH1F *HBHE_TSRatio_D2		      = makeTH1F("HBHE_TSRatio_D2","HBHE: TS3>30fC  Depth 2", 30, 0,0);
  TH1F *HBHE_TSRatio_D3		      = makeTH1F("HBHE_TSRatio_D3","HBHE: TS3>30fC  Depth 3", 30, 0,0);
  TH1F *HBHE_TSRatio_a		      = makeTH1F("HBHE_TSRatio_a ","HBHEa: TS3>30fC", 30, 0,0);
  TH1F *HBHE_TSRatio_b		      = makeTH1F("HBHE_TSRatio_b ","HBHEb: TS3>30fC", 30, 0,0);
  TH1F *HBHE_TSRatio_c		      = makeTH1F("HBHE_TSRatio_c ","HBHEc: TS3>30fC", 30, 0,0);

  TH1F *HBHE_TSRatio_fC1_D1	      = makeTH1F("HBHE_TSRatio_fC1_D1","HBHE: 30fC<TS3<100fC    Depth 1", 30, 0,0);
  TH1F *HBHE_TSRatio_fC2_D1	      = makeTH1F("HBHE_TSRatio_fC2_D1","HBHE: 100fC<TS3<200fC   Depth 1", 30, 0,0);
  TH1F *HBHE_TSRatio_fC3_D1	      = makeTH1F("HBHE_TSRatio_fC3_D1","HBHE: 200fC<TS3<600fC   Depth 1", 30, 0,0);
  TH1F *HBHE_TSRatio_fC4_D1	      = makeTH1F("HBHE_TSRatio_fC4_D1","HBHE: 600fC<TS3<2000fC  Depth 1", 30, 0,0);

  TH1F *HBHE_TSRatio_fC1_D2	      = makeTH1F("HBHE_TSRatio_fC1_D2","HBHE: 30fC<TS3<100fC    Depth 2", 30, 0,0);
  TH1F *HBHE_TSRatio_fC2_D2	      = makeTH1F("HBHE_TSRatio_fC2_D2","HBHE: 100fC<TS3<200fC   Depth 2", 30, 0,0);
  TH1F *HBHE_TSRatio_fC3_D2	      = makeTH1F("HBHE_TSRatio_fC3_D2","HBHE: 200fC<TS3<600fC   Depth 2", 30, 0,0);
  TH1F *HBHE_TSRatio_fC4_D2	      = makeTH1F("HBHE_TSRatio_fC4_D2","HBHE: 600fC<TS3<2000fC  Depth 2", 30, 0,0);
